...
/**
 * This class provides a wrapper for network errors when making requests to Visier Object Configuration APIs
 */
export class VisierObjectConfigurationError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "VisierObjectConfigurationError";
